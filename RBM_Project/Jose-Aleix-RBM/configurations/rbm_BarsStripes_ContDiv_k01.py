...
TrainRout = "ContDiv"   # Can be "GradDesc" for gradient descent or "ContDiv"
                        #   for contrastive divergence
Persistent = False      # True for persistent CD
Weighted   = True       # True for Weighted CD

NumHid = 16             # Number of hidden neurons
NeuronType = 0          # It is 0 or 1 for {0, 1} or {-1, 1} neurons.
CDk = 1                 # Iterations of contrastive divergence

Sigma = 0.1             # Variance of initial weights
LRate = 0.001           # Learning rate: it usually changes from 0.1 to 0.001
Momentum = 0.9          # Momentum of the training usually 0.9
WeightDecay = 0         # L2 regularization
MinEpochs = 200         # Minimum number of epochs
MaxEpochs = 20000       # Maximum number of epochs 
nPrint = 50             # Print probabilities and KL every nPrint iterations
MiniBatchSize = None    # If it is None, the gradient is computed for all 
